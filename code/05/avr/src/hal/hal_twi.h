...
// "I2C protocol", "Commands" and "Status read". Every received byte is ACKed
// and handed to task_cmd; every read returns what task_cmd_read() assembled,
// then 0xFF. Nothing here decides anything about a command.
...
// START that ended its frame. Clears the flag, so a second call returns false.
